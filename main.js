  ...
  const recommendProduct = hourlyEnergyRequired => {
    ...
    switch (true) {
      case hourlyEnergyRequired < 1000:
        offer = "1kwh Flexible Monocrystalline Solar Panels";
        console.log("I am here 1");
        break;
      case hourlyEnergyRequired < 5000:
        offer = "2-5kwh Foldable Solar Panels";
        break;
      case hourlyEnergyRequired < 7000:
        offer = "7kwh Polycrystalline High Efficient Solar Panels";
        break;
      case hourlyEnergyRequired < 10000:
        offer = "10kwh Polycrystalline Solar Panels";
        break;
      default:
        offer = "Industrial Workhorse Polycrystalline Solar Panels";
    }
    return offer;
  };
